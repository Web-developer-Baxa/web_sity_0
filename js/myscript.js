...
jQuery(window).load(function() {
	if (jQuery(window).width() > 1025){
		...
		jQuery('#testimonials').parallax("0", -0.5);
		jQuery('#facts').parallax("0", -0.5);
		jQuery('footer').parallax("0", -0.5);
	}
	...
	$("#ajax-contact-form").submit(function() {
		...
		$.ajax({
			...
			success: function(msg) {
				// Ниже текст после отправки сообщения
				if(msg == 'OK') {
...
/*-----------------------------------------------------------------------------------*/
/*	Цифровое табло - мелькание чисел
/*-----------------------------------------------------------------------------------*/
(function($) {
    $.fn.countTo = function(options) {
        // слияние настроек плагина по умолчанию с пользовательскими параметрами
        options = $.extend({}, $.fn.countTo.defaults, options || {});

        // сколько раз обновлять значение и сколько увеличивать значение каждого обновления
